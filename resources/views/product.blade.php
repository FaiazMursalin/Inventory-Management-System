        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 mb-4">
                    ...
                    ?>
                    @if (count($images)==0)
                        <img src="{{is_null($product->primary_image)?asset('/frontend/assets/img/default.png'):asset('/storage/'.$product->primary_image)}}" class="img-fluid" alt="product">
                        ...
                        <div class="carousel-inner">
                            @for ($i = 0; $i < count($images)+1; $i++)
                                <div class="carousel-item {{$i==0?'active':''}}">
                                    @if ($i==0)
                                        {{-- <img class="d-block w-100" src="{{is_null($product->primary_image)?asset('/frontend/assets/img/default.png')::asset('/storage/'.$product->primary_image)}}"> --}}
