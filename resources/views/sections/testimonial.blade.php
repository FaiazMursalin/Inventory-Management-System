            ...
            <div class="col-12 col-lg-6">
                @foreach ($testimonials as $testimonial)
                    ...
                    <div class="customer-testimonial d-flex mb-5">
                        <img src="{{is_null($testimonial->image)? asset('/frontend/assets/img/default.png'):asset('/storage/'.$testimonial->image)}}" class="image image-sm mr-3 rounded-circle shadow" alt="user">
