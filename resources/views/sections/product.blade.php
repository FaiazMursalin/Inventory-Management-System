    ...
    <div class="card card-product card-plain">
        <div class="card-image">
            <a href="/product/{{$product->slug}}">
                ...
                {{-- <img src="{{ isn_null($product->primary_image)?asset('//frontend/assets/img/default.png/'):asset('/storage/'.$product->primary_image)}}" />
                --}}
                <img src="{{ is_null($product->primary_image)? asset('/frontend/assets/img/default.png') :asset('/storage/'.$product->primary_image) }}" />
            </a>
        </div>
